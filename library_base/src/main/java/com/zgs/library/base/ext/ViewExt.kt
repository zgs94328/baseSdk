...
import com.zgs.library.base.util.FixClickSpanTouchListener
...
fun View.singleClick(duration: Long = 500, action: (view: View) -> Unit) {
...
fun View.toBitmap(): Bitmap {
    if (measuredWidth == 0 || measuredHeight == 0) {
        Log.e(
            "${AppUtils.getApplication().packageName}",
            "⚠️警告！View.toBitmap()：调用该方法时，请确保View已经测量完毕，当前View宽或高为0，直接Return!"
        )
