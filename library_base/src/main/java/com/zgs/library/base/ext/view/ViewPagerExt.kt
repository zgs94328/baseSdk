...
import com.zgs.library.base.ext.margin
...
fun ViewPager.asCard(
    pageMargin: Int = this.context.dp2px(30f),
    hpadding: Int = this.context.dp2px(30f),
    vpadding: Int = this.context.dp2px(20f)
): ViewPager {
...
class CardPagerTransformer() : ViewPager.PageTransformer {
    private val maxTranslateOffsetX: Int = 360
...
fun ViewPager2.asCard(
    pageMargin: Int = this.context.dp2px(10f),
    hpadding: Int = this.context.dp2px(30f),
    vpadding: Int = this.context.dp2px(20f),
    offsetVal: Int = this.context.dp2px(150f),
...
class CardPager2Transformer(
    ...
    var offsetVal: Int = 300,
    var scaleRatio: Float = 0.3f, var pageMargin: Int = 20
